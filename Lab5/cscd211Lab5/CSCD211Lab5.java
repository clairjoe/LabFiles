...
public class CSCD211Lab5
{
   ...
   public static void main(String [] args) throws Exception
   {
      ...
      cars = Lab5Methods.fillArray(kb, 5);  // 5 cars in the array
      ...
      do
      {
         ...
         switch(choice)
         {
            ...
            case 2:  aCar = Lab5Methods.createBoxCar(kb);
                     res = myList.add(aCar);
                     System.out.println("The results of add " + res);
                     break;
            
            case 3:  cars = Lab5Methods.fillArray(kb, 3);
                     index = Lab5Methods.readIndex(kb);
                     res = myList.addAll(index, cars);
                     System.out.println("The results of addAll " + res);

                     break;
            
            case 4:  index = Lab5Methods.readIndex(kb);
            ...
            case 7:  index = Lab5Methods.readIndex(kb);
